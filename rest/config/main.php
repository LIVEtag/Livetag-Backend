            ...
            'rules' => [
                ...
                [
                    ...
                    'extraPatterns' => [
                        ...
                        'GET {id}/snapshot' => StreamSessionController::ACTION_SNAPSHOTS,
                        'OPTIONS {id}/snapshot' => StreamSessionController::ACTION_OPTIONS,
                        'GET {id}/presented-product' => StreamSessionController::ACTION_PRESENTED_PRODUCTS,
                        'OPTIONS {id}/presented-product' => StreamSessionController::ACTION_OPTIONS,

...
class m140506_102106_rbac_init extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        $this->createTable($authManager->itemTable, [
            ...
            'ruleName' => $this->string(64),
            'data' => $this->binary(),
            'createdAt' => $this->integer(),
            'updatedAt' => $this->integer(),
            'PRIMARY KEY ([[name]])',
            'FOREIGN KEY ([[ruleName]]) REFERENCES ' . $authManager->ruleTable . ' ([[name]])' .
        ...
        $this->createTable($authManager->assignmentTable, [
            ...
            'FOREIGN KEY ([[itemName]]) REFERENCES ' . $authManager->itemTable . ' ([[name]])' .
                $this->buildFkClause('ON DELETE CASCADE', 'ON UPDATE CASCADE'),
        ], $tableOptions);
        ...
        if ($this->isMSSQL()) {
            ...
            IF COLUMNS_UPDATED() > 0
                ...
                ruleName = (SELECT ruleName FROM inserted),
                data = (SELECT data FROM inserted),
                createdAt = (SELECT createdAt FROM inserted),

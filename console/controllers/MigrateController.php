...
use yii\console\controllers\MigrateController as ConsoleMigrateController;

/**
 * Description of MigrateController
 *
 * Used to use external migrations(from logs or another modules)
 */
class MigrateController extends ConsoleMigrateController
{
    /**
     * @var array
     */

...
$this->title = Yii::t('rbac-backend', 'Assignments') . ' : ' . $userName;;
$this->params['breadcrumbs'][] = ['label' => Yii::t('rbac-backend', 'Assignments'), 'url' => ['index']];

...
class Generator extends ModelGenerator
{
    ...
    /**
     * get relation constant name
     * @param string $relation
     * @return string
     */
    public static function relationConstant($relation)
    {
        return 'REL_' . strtoupper(self::fromCamelCase($relation));
    }
     ...
     * @return string
     */
    protected static function fromCamelCase($input)
    {

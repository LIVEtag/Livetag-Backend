...
Ссылки:
- Полезная [статья](https://wiki.gbksoft.net/admin:gitlab:tricks) для некоторых весьма поленых доп. фич и шаблонов которые можно использовать в файле `.gitlab-cy.yml`.
